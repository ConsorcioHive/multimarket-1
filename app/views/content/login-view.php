                                            ...
                                            <div class="position-relative h-100 d-flex flex-column">
                                                <div class="mb-4">
                                                    <a href="index.html" class="d-block">
                                                        <img src="<?php echo APP_URL; ?>library/html/material/assets/images/logo-light.png" alt="" height="18">
                                                    </a>
                                                </div>
                                                <div class="mt-auto">
                                                    <div class="mb-3">
                                            ...
                                            <div class="mt-4">
                                                <form action="https://themesbrand.com/velzon/html/material/index.html">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="login_usuario" pattern="[a-zA-Z0-9]{4,20}" maxlength="20" required  class="form-control" id="username" placeholder="Enter username">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                                            ...
                                                            <input type="password" class="form-control pe-5 password-input" placeholder="Enter password" id="password-input" name="login_clave" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" required>
