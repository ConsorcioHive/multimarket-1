	...
	class marketController extends mainModel{
		...
		public function listarMarketControlador($pagina,$registros,$url,$busqueda){
			...
			if(isset($busqueda) && $busqueda!=""){
				...
				$consulta_datos="SELECT * FROM market WHERE ((market_id!='".$_SESSION['id']."' AND market_id!='1') AND (market_nombre LIKE '%$busqueda%' OR market_telefono LIKE '%$busqueda%' OR market_email LIKE '%$busqueda%' OR market_direccion LIKE '%$busqueda%')) ORDER BY market_nombre ASC LIMIT $inicio,$registros";

				$consulta_total="SELECT COUNT(market_id) FROM market WHERE ((market_id!='".$_SESSION['id']."' AND market_id!='1') AND (market_nombre LIKE '%$busqueda%' OR market_direccion LIKE '%$busqueda%' OR market_email LIKE '%$busqueda%' OR market_telefono LIKE '%$busqueda%'))";

			}else{

				$consulta_datos="SELECT * FROM market WHERE market_id!='".$_SESSION['id']."' AND market_id!='1' ORDER BY market_nombre ASC LIMIT $inicio,$registros";

				$consulta_total="SELECT COUNT(market_id) FROM usuario WHERE market_id!='".$_SESSION['id']."' AND market_id!='1'";
					...
					$tabla.='
						<tr class="has-text-centered" >
							...
							<td>'.$rows['market_direccion'].'</td>
			                    <a href="'.APP_URL.'userUpdate/'.$rows['market_id'].'/" class="button is-success is-rounded is-small">
